                    ...
                    <div className="card-body">
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="email" className="form-control" name="email" minLength="2" onChange={this.onChange} value={this.state.email}  />
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="balance" onChange={this.onChange} value={this.state.balance} disabled={disableBalanceOnAdd} />
                            </div>
